    ...
    try {
      if (i.isButton()) {
        const closeButton = new ButtonBuilder()
          .setEmoji("<:icons_close:1443979986905337976>")
          .setCustomId("close")
          .setStyle(ButtonStyle.Secondary)
          .setLabel("Close");

        const deleteButton = new ButtonBuilder()
          .setEmoji("<:icons_delete:1443979836229161094>")
          .setCustomId("delete")
          .setStyle(ButtonStyle.Secondary)
          .setLabel("Delete")
        ...
        const openButton = new ButtonBuilder()
          .setEmoji("<:open:1443980148192841728>")
          .setCustomId("Open")
          .setStyle(ButtonStyle.Secondary)
          .setLabel("Open")
            ...
            const row = new ActionRowBuilder()
              .addComponents(
                new ButtonBuilder()
                  ...
                  .setEmoji('<:iconsss_Download:1443979469093208145>')
