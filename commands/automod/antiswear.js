...
module.exports = {
    name: 'antiswear',
    usage: 'Filter profanity and swearing',
    aliases: [],
    cooldown: 5,
    category: 'automod',
    ...
    run: async (client, message, args) => {
        ...
        let prefix = message.guild.prefix || client.config.PREFIX // Correct way to define default prefix
            ...
            case 'enable':
                if (!isActivatedAlready) {
                    ...
                    const antilinkSettingsEmbed = client.util.embed()
                        .setTitle(
                            `AntiSwear Settings for ${message.guild.name} ${client.emoji.protect}`
                        )
                        .setColor(client.color)
                        .setDescription(
