...
To enable use antinuke enable ** `)
            ...
            const wl = client.util.embed()
                ...
                .addFields([
                    {
                        name: `__**Usage**__`,
                        value: `<:${client.user.username}_dot_1:1181287240870146139> \`${message.guild.prefix}whitelist @user/id\`\n<:${client.user.username}_dot_1:1181287240870146139> \`${message.guild.prefix}wl @user\``
                    }
                ])
